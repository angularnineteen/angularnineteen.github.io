...
describe('StaleNewsCardComponent', () => {
  ...
  it('should render title and subtitle', fakeAsync(() => {
  ...
  it('should render authors', fakeAsync(() => {
  ...
  it('should render canonical URL', fakeAsync(() => {
  ...
  it('should render long form text', fakeAsync(() => {
  ...
  it('should handle empty long form text', fakeAsync(() => {
